...
function shuffleQuestionsArray() {
  ...
  // Slice to get only the first 5 questions for the current session
...
function endGame() {
  ...
  if (isWin) {
    ...
    // // <br> 
    // // <span style='color: #ED1F23; font-size: 8vw; font-weight: bold;'>Congratulation!Press the button for Wheel</span> 
    // // <br>
    ...
    // // </div>
    // `;
    scoreElement.innerHTML = `<span style='color: #1B92D0; font-size: 1.2em; font-weight: bold;'>Congratulation!You Got</span> <br> <span style='font-size: .8em;'>${score} out of ${questions.length}</span>`;
